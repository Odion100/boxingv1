...
.service('$$eachesCalc',['$http', 'Upload', '$$msgbox', function($http, $upload, $$msgbox){

    var instance = function(unit_breakdown){    
	    var eachesCalc = this;
	    eachesCalc.unit_breakdown = unit_breakdown || [{sku:'MISSING ASIN DATA!!!', multiple:0}];
	    ...
	    function toUnits(eaches){
	        ...
	        if(eachesCalc.unit_breakdown[0].multiple != 0){
	    ...
	    eachesCalc.toSKU_HTML = function(){
	        ...
	        return '<span style="font-weight:bold;white-space: nowrap;">' + sku + '</span>'     
	    }
